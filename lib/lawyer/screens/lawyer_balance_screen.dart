...
class LawyerBalanceScreen extends StatelessWidget {
  final String currentBalance;

  const LawyerBalanceScreen({super.key, this.currentBalance = '0.00'});
...
class LawyerWalletPasscodeDialog extends StatefulWidget {
  const LawyerWalletPasscodeDialog({super.key});
  ...
  static Future<bool> show(BuildContext context) async {
    final result = await showDialog<bool>(
      ...
      builder: (context) => const LawyerWalletPasscodeDialog(),
    );
    return result ?? false;
  }

  @override
  State<LawyerWalletPasscodeDialog> createState() => _LawyerWalletPasscodeDialogState();
}

class _LawyerWalletPasscodeDialogState extends State<LawyerWalletPasscodeDialog> {
