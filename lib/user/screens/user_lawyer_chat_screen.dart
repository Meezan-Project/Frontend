...
class _UserLawyerChatScreenState extends State<UserLawyerChatScreen> {
  ...
  void _sendMessage() async {
    ...
    // Add message to subcollection matching the lawyer's schema
  ...
  Widget _buildMessageBubble(String text, String time, bool isMe, bool isDark) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            time,
            style: GoogleFonts.cairo(color: Colors.grey, fontSize: 10.sp),
          ),
        ],
      ),
    );
