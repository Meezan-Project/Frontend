    ...
    try {
        ...
        try {
          ...
          if (mounted) {
            ...
            await _showCenteredResultDialog(
              ...
              title: 'Password Update Failed'.translate(),
        ...
        try {
          ...
          if (mounted) {
            ...
            await _showCenteredResultDialog(
              ...
              title: 'Email Update Failed'.translate(),
      ...
      if (_selectedProfilePhoto != null) {
        ...
        if (uploaded == null || uploaded.trim().isEmpty) {
          ...
          await _showCenteredResultDialog(
            ...
            title: 'Photo Upload Failed'.translate(),
      ...
      if (mounted) {
        ...
        await _showCenteredResultDialog(
          ...
          title: 'Profile Updated'.translate(),
